...
gx.define('rwdrecentlinks', true, function (CmpContext) {
   ...
   this.PackageName =  "com.chekin" ;
   this.ServerFullClass =  "com.chekin.rwdrecentlinks" ;
   ...
   this.LinksContainer = new gx.grid.grid(this, 2,"WbpLvl2",8,"Links","Links","LinksContainer",this.CmpContext,this.IsMasterPage,"rwdrecentlinks",[],true,9999,false,true,0,false,false,false,"",0,"px",0,"px","New row",false,false,false,null,null,false,"",true,[1,0,0,0],false,0,false,false);
